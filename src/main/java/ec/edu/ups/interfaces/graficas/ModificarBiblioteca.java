...
public class ModificarBiblioteca {
    ...
    public static void main(String [] args) {
        ...
        //textField
        TextField nomBiblio = new TextField("Nombre Biblioteca", 50);
        TextField direccion = new TextField("Dirección", 50);
        //Boton
        ...
        miVentana.setTitle("Crear/Modificar");
        //Centra la ventana
